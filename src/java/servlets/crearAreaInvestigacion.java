 ...
 */
@WebServlet(name = "crearAreaInvestigacion", urlPatterns = {"/crearAreaInvestigacion"})
public class crearAreaInvestigacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String respuesta = gest.nuevaAreaInvestigacion(id, nombre);
