<%@page import="Modelo.ProyeccionSocial"%>
<%@page import="Gestion.GestionProyeccionSocial"%>
<%@page import="Gestion.GestionProyeccionSocial"%>
<%-- 
    Document   : Proyecciones
...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="public/css/proyeccionSocial.css">
    ...
    <body>
        ...
        <div class="margin-sides">
            <form method="GET" action="filtroProyeccionSocial">
                <div class="form-row">
            ...
            <table class="table">
                <caption>Lista de Proyecciones Sociales</caption>
                <thead class="thead-blue">
                    <tr class="color-white">
                        <th scope="col">#Codigo</th>
                        <th scope="col">Nombre Proyecciones Sociales</th>
                    </tr>
                </thead>
                <tbody class="color-black">

                    <%
                        GestionProyeccionSocial gest = new GestionProyeccionSocial();
                        if (request.getAttribute("filtro") == null || request.getAttribute("filtro").toString().equals("")) {
                            ArrayList<ProyeccionSocial> proyeccionesSociales = gest.listaProyeccionesSociales();
                            if (proyeccionesSociales != null) {
                                for (ProyeccionSocial proyeccionSocial : proyeccionesSociales) {
                                    out.print("<tr>");
                                    out.print("<td class='text-justify'>" + proyeccionSocial.getId() + "</td>");
                                    out.print("<td class='text-justify'>" + ProyeccionSocial.getProyeccionSocial()+ "</td>");
                                    out.print("</tr>");
                                }
                            }
                            ...
                            ArrayList<ProyeccionSocial> proyeccionesSociales = gest.listaProyeccionesSocialesFiltro(filtro);
                            if (proyeccionesSociales != null) {
                                for (ProyeccionSocial proyeccionSocial : proyeccionesSociales) {
                                    out.print("<tr>");
                                    out.print("<td class='text-justify'>" + proyeccionSocial.getId() + "</td>");
                                    out.print("<td class='text-justify'>" + proyeccionSocial.getNombre() + "</td>");
                                    out.print("</tr>");
                                }
                            }
                        }
        ...
        <div class=" margin-bottom">
            <ul class="nav nav-pills pills-bg">
                <li class="nav-item">
                    <a class="nav-link" href="#nueva" data-toggle="tab">Nueva Proyección Social</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#modifica" data-toggle="tab">Modificar Proyección Social</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#elimina" data-toggle="tab">Eliminar Proyección Social</a>
                </li>
            </ul>
            <div class="tab-content">
                <div id="nueva" class="tab-pane fade">
                    <form class="margin-sides" action="crearProyeccionSocial" method="GET">
                        <div class="row">
                            <div class="col">
                        ...
                        <br>
                        <button type="submit" class="btn btn-lg btn-success btn-mid">Nueva Proyección Social</button>
                    </form>
                </div>

                <div id="modifica" class="tab-pane fade">
                    <form class="margin-sides" method="GET" action="modificarProyeccionSocial" id="modificaform">
                        <div class="row">
                            <div class="col">
                                <label for="inCod">Codigo:</label>
                        ...
                        <br>
                        <button type="button" id="btnmod" class="btn btn-lg btn-warning btn-mid">Modificar Proyección Social</button>
                    </form>

                </div>

                <div id="elimina" class="tab-pane fade">
                    <form class="margin-sides" id="formdel" method="GET" action="eliminaProyeccionSocial">
                        <div class="row">
                            <div class="col">
                                <label for="inCod">Codigo:</label>
                        ...
                        <br>
                        <button type="button" id="btndel" class="btn btn-lg btn-danger btn-mid">Eliminar Proyección Social</button>
                    </form>
